...
echo " "
echo "checking if you have vim installed on your machine, if not then install it"
$su_user vim --version > /dev/null 2>&1
if [ $? -eq 0 ]; then
  echo " "
...
# install pyyaml 
echo " "
echo "installing pyyaml using pip3"
$su_user pip3 install pyyaml
echo " "
echo "installing jq using the package manager"
$su_user $pkg_mgr install jq -y
